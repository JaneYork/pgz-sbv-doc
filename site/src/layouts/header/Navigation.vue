<template>
  <a-menu
    ...
    disabled-overflow
  >
    <a-menu-item v-if="true" key="intro">
      <router-link :to="getLocalizedPathname('/intro/vue/intro', isZhCN)">
        {{ $t('app.header.menu.intro') }}
      </router-link>
    </a-menu-item>
    <a-menu-item v-if="false" key="docs/vue">
    ...
    <a-menu-item v-if="false" key="store">
      <a
    ...
    <a-menu-item v-if="isZhCN && false" key="geektime">
      <a
    ...
    <template v-if="isMobile">
      ...
      <a-menu-item v-if="false" key="github">
